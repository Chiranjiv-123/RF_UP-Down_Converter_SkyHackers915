...
class AM_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(118e6, 0)
        self.uhd_usrp_source_0.set_antenna("TX/RX", 0)
        self.uhd_usrp_source_0.set_bandwidth(10e3, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, (int(self.samp_rate/self.decim)), 500, 6000, 400, window.WIN_HAMMING, 6.76))
