...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.sample_rate = sample_rate = 64000
        ...
        self._frequency_range = Range(0, sample_rate, sample_rate/5, 50, 200)
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, sample_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * sample_rate) if "auto" == "time" else int(0.1), 1) )
        self.analog_sig_source_x_0 = analog.sig_source_f(sample_rate, analog.GR_SIN_WAVE, frequency, 1, 0, 0)
