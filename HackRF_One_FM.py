...
class HackRF_One_FM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HackRF One FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HackRF One FM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "HackRF_One_FM")
        ...
        self.samp_rate = samp_rate = 8*10e5
        self.if_gain = if_gain = 20
        self.channel_width = channel_width = 200*10e2
        self.channel_freq = channel_freq = 93.5*10e5
        self.center_freq = center_freq = 93.5e6

        ##################################################
        # Blocks
        ##################################################

        self._center_freq_range = Range(85e6, 110e6, 100e3, 93.5e6, 200)
        ...
        self._vga_gain_range = Range(0, 62, 1, 20, 200)
        ...
        self.uhd_usrp_source_0.set_center_freq(93.5e6, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (75*10e2), (25*10e2), window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=HackRF_One_FM, options=None):
